...
app.get("/posts/:post_title", function(req, res){
  ...
  let urlTitleParam = _.kebabCase(req.params.post_title);
  let result = posts.find(post=>_.kebabCase(post.title) === urlTitleParam);
  if(result)
  {
      console.log("Match found for: " + urlTitleParam);
   }else{
     console.log("No match found for: " + urlTitleParam);
   }
